...
import {
  ...
  SlidersHorizontal, User, Building2, Layers, Users, Tag, Maximize2, ArrowLeft, Database
} from "lucide-react";
import { saveCanvasUpload, loadUserCanvases, createCanvas, upsertCanvas, loadCanvasById, uploadDocumentToStorage, createImportJob, updateImportJob, indexDocumentChunks, loadDossierFiles, deleteDossierFile, deleteCanvas } from "./services/canvasStorage";
import { AuthProvider, useAuth } from "./services/authContext";
import LoginScreen from "./LoginScreen";
import JSZip from "jszip";
import * as pdfjsLib from "pdfjs-dist";

// Strategie feature — lazy loaded (Sprint 4C)
...
// Sprint 4C — extracted to feature modules:
// WandButton, MagicResult          → src/shared/components/
// TagPill, ALL_TAGS, EXTERN_TAGS   → src/shared/components/TagPill.jsx
// WerkbladTextField, AnalyseSection, KsfKpiRow, ThemaAccordeon
// StrategieWerkblad                → src/features/strategie/
