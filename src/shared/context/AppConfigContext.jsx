...
const LABEL_FALLBACKS = {
  ...
  "klanten.verbeterrichting.counter.verstuurd":      "verstuurd",
  ...
  "klanten.verbeterrichting.status.verstuurd":       "verstuurd",
  ...
  "klanten.verbeterrichting.handover.datum":         "verstuurd op",
  "klanten.verbeterrichting.handover.tooltip":       "Markeer deze richting als verstuurd naar Roadmap (stub — Roadmap-werkblad volgt)",
