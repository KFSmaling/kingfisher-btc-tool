...
const LABEL_FALLBACKS = {
  ...
  "label.klanten.werkblad.titel":           "Klanten & Dienstverlening",
  "label.klanten.section.werkruimte":       "Werkruimte",
  "label.klanten.section.rapport":          "Rapport",
  "label.klanten.fase.1.titel":             "Inventarisatie",
  "label.klanten.fase.2.titel":             "Pijnpunten",
  "label.klanten.fase.3.titel":             "Analyse",
  "label.klanten.fase.4.titel":             "Verbeterrichtingen",
  "label.klanten.fase.disabled.tooltip":    "komt in latere sprint",
  "label.klanten.dimensie.klantsegment":    "Klantsegmenten",
  "label.klanten.dimensie.propositie":      "Proposities",
  "label.klanten.dimensie.kanaal":          "Kanalen",
  "label.klanten.veld.klantsegment.omvang":             "Omvang",
  "label.klanten.veld.klantsegment.strategisch_belang": "Strategisch belang",
  "label.klanten.veld.klantsegment.karakteristieken":   "Karakteristieken",
  "label.klanten.veld.klantsegment.behoeften":          "Behoeften",
  "label.klanten.veld.propositie.differentiatie":       "Differentiatie",
  "label.klanten.veld.propositie.prijsstelling":        "Prijsstelling",
  "label.klanten.veld.propositie.levensfase":           "Levensfase",
  "label.klanten.veld.propositie.concurrentiepositie":  "Concurrentiepositie",
  "label.klanten.veld.kanaal.type":         "Type",
  "label.klanten.veld.kanaal.bereik":       "Bereik",
  "label.klanten.veld.kanaal.ervaring":     "Ervaring",
  "label.klanten.veld.kanaal.economie":     "Economie",
  "label.klanten.modal.item.titel.add":     "Nieuw item",
  "label.klanten.modal.item.titel.edit":    "Item bewerken",
  "label.klanten.knop.dimensie.toevoegen":  "+ dimensie",
  "label.klanten.knop.item.toevoegen":      "+ item",
  "label.klanten.knop.item.opslaan":        "Opslaan",
  "label.klanten.knop.item.annuleren":      "Annuleren",
  "label.klanten.rapport.titel":            "Klanten & Dienstverlening — overzicht",
  "label.klanten.rapport.section.samenvatting": "Samenvatting",
  "label.klanten.rapport.section.huidig":   "Huidige situatie",
  "label.klanten.rapport.section.patronen": "Patronen",
  "label.klanten.rapport.section.richtingen": "Verbeterrichtingen",
  "label.klanten.rapport.knop.print":       "PDF / Printen",
  "label.klanten.ai.cluster":               "Cluster-analyse",
  "label.klanten.ai.paradox":               "Paradox-detectie",
  "label.klanten.ai.positionering":         "Positionering",
  "label.klanten.ai.overstijgend":          "Overstijgend",
  "label.klanten.ai.disabled.tooltip":      "AI komt in fase 3",
  "label.klanten.helper.iteratief":         "werk in uitvoering — geen 'klaar' status",
  "label.klanten.helper.fase.geen_volgorde":"geen verplichte volgorde",
};
