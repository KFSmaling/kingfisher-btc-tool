...
const LABEL_FALLBACKS = {
  ...
  // 11.S-fix Bev 4: voortgangs-fase-tekst (Kees-feedback "proces voortgang?")
  "analysis.loading.collecting":             "Inputs verzamelen…",
  "analysis.loading.ai_running":             "AI analyseert uw strategie… (dit duurt 20-40 seconden)",
  "analysis.loading.merging":                "Resultaten samenvoegen…",
  // 11.S-fix Bev 2: badge bij behouden insight (merge-strategie)
  "analysis.label.carried_over":             "behouden uit vorige analyse",
  "analysis.label.carried_over.tooltip":     "Behouden uit vorige analyse — gemarkeerd als 'in rapport' of door consultant bewerkt",
  // 11.S-fix Bev 3: AI-overload (429/529) user-friendly
  "strategie.analyse.overload":              "AI is momenteel overbelast — probeer over 1 minuut opnieuw.",
  // 11.S-fix Bev 8: nieuwe tips-tab-secties + extra strategie-veld-titels
  "strat.field.analyse":                     "Analyse · SWOT",
  "strat.field.themas":                      "Strategische thema's",
  "strat.field.ksf_kpi":                     "KSF & KPI",
  "tips.strategie.analyse.uitgebreid":       "",
  "tips.strategie.analyse.voorbeeld":        "",
  "tips.strategie.executie.uitgebreid":      "",
  "tips.strategie.executie.voorbeeld":       "",
  "tips.strategie.extern.uitgebreid":        "",
  "tips.strategie.extern.voorbeeld":         "",
  "tips.strategie.intern.uitgebreid":        "",
  "tips.strategie.intern.voorbeeld":         "",
  "tips.strategie.themas.uitgebreid":        "",
  "tips.strategie.themas.voorbeeld":         "",
  "tips.strategie.ksf_kpi.uitgebreid":       "",
  "tips.strategie.ksf_kpi.voorbeeld":        "",
  "analysis.filter.label":                   "Toon:",
  "analysis.filter.type":                    "Filter type",
  "analysis.sourceref.header":               "Verwijst naar",
  // RFC-008 §4 — InzichtenOverlay edit-mode + in_rapport-toggle + status-indicator
  "analysis.inrapport.aan":                  "in rapport: aan",
  "analysis.inrapport.uit":                  "in rapport: uit",
  "analysis.status.opgenomen":               "opgenomen in Rapportage",
  "analysis.action.bewerk":                  "Bewerk bevinding",
  "analysis.action.save":                    "Opslaan",
  "analysis.action.saving":                  "Opslaan…",
  "analysis.action.cancel":                  "Annuleer",
  "analysis.label.bewerkt":                  "bewerkt",
  "analysis.regen.title":                    "Bevindingen handmatig bewerkt",
  "analysis.regen.body":                     "Je hebt bevindingen handmatig bewerkt. Bij her-genereren gaan deze edits verloren. Doorgaan?",
  "analysis.regen.confirm":                  "Doorgaan",
  "werkblad.strategie.inzichten.header":     "Inzichten — Strategie",
  // 11.S Block 2 — RapportageMenu + PPT-info-dialog
  "rapportage.menu.header":                  "Kies rapportage",
  "rapportage.menu.subtekst":                "Kies een export-vorm. Elke vorm gebruikt de huisstijl van het canvas of de klant en pakt de actuele data van dit werkblad.",
  "rapportage.tile.onepager.titel":          "One-pager · A4 landschap",
  "rapportage.tile.onepager.body":           "Kies welke modellen op de pagina komen. Toggle voor met/zonder AI-inzichten. Print of PDF.",
  "rapportage.tile.onepager.badge":          "Populair",
  "rapportage.tile.ppt.titel":               "PowerPoint-export · 8–12 slides",
  "rapportage.tile.ppt.body":                "Genereert een volledig deck met titel, executive summary, één slide per model, en aandachtspunten als appendix. Bewerkbaar in PowerPoint.",
  "rapportage.tile.ppt.badge":               "Beschikbaar fase 2",
  "rapportage.ppt.info.titel":               "PowerPoint-export",
  "rapportage.ppt.info.body":                "Beschikbaar in fase 2.\n\nGenereert een volledig deck:\n- Titel-slide + executive samenvatting\n- Eén slide per strategisch thema (KSF/KPI)\n- Eén slide per model (SWOT, etc.)\n- Appendix met aandachtspunten\n\nWil je nu al een one-pager?",
  "rapportage.ppt.info.cta":                 "Open one-pager",
  "rapportage.tip":                          "Tip: open Inzichten eerst — daar krijg je AI-advies dat je kan opnemen in deze exports.",
  "rapportage.footer.label":                 "Binnenkort",
  "rapportage.footer.chips":                 "Gamma · Word-rapport · PDF compleet · E-mail-samenvatting",
  "rapportage.action.close":                 "Sluit",
  // 11.S Block 3 — OnepagerBuilder + ModelLibrary + A4Preview (shared)
  "onepager.builder.header.back":            "Terug naar werkblad",
  "onepager.builder.header.titel":           "One-pager builder",
  "onepager.builder.action.print":           "Print / PDF",
  "onepager.builder.action.print.tooltip":   "Print of opslaan als PDF",
  "onepager.ai_toggle.titel":                "Met AI-inzichten",
  "onepager.ai_toggle.body.aan":             "De one-pager bevat de {N} bevindingen die je in Inzichten markeerde voor het rapport.",
  "onepager.ai_toggle.body.uit":             "One-pager toont alleen jouw eigen inhoud — zonder AI-bevindingen.",
  "onepager.modellib.vaste_blokken.titel":   "Altijd zichtbaar",
  "onepager.modellib.groups.titel":          "Kies modellen",
  "onepager.modellib.selectie.titel":        "Volgorde op A4 · {N} gekozen",
  "onepager.modellib.selectie.empty":        "Nog geen modellen gekozen — vink hierboven aan.",
  "onepager.modellib.action.up":             "Omhoog",
  "onepager.modellib.action.down":           "Omlaag",
  "onepager.modellib.action.remove":         "Verwijder",
  "onepager.modellib.disabled.reason.prefix":"Disabled: ",
  "onepager.preview.kicker":                 "One-pager · A4 landschap",
  "onepager.preview.h1.placeholder":         "Strategische samenvatting",
  "onepager.preview.selectie.titel":         "Modellen",
  "onepager.preview.model.placeholder":      "Block 4 vult dit blok met inhoud uit de werkblad-data.",
  "onepager.preview.insights.titel":         "Aandachtspunten uit Inzichten",
  "onepager.preview.insights.suffix":        "bevindingen opgenomen — Block 4 vult de tekst in",
  "onepager.preview.fallback.samenvatting":  "Strategische samenvatting nog niet gegenereerd. → Genereer in werkblad.",
  "onepager.preview.fallback.identiteit":    "Vul Missie, Visie en Ambitie eerst in onder Strategie-werkblad → Identiteit.",
  "onepager.preview.fallback.kpi":           "Voeg minstens 4 KPI's toe verdeeld over de thema's voor een complete strip.",
  "onepager.preview.fallback.themas":        "Geen strategische thema's gedefinieerd — voeg eerst minstens één thema toe.",
  "onepager.preview.fallback.insights":      "Geen bevindingen geselecteerd in Inzichten.",
  // Strategie-specifieke vaste-blokken + model-namen + disabled-reasons
  "strategie.onepager.vast.identiteit.label":    "Identiteits-band",
  "strategie.onepager.vast.identiteit.sub":      "Missie · Visie · Ambitie · Kernwaarden",
  "strategie.onepager.vast.kpi.label":           "KPI-strip",
  "strategie.onepager.vast.kpi.sub":             "Top 4 KPI's auto-geselecteerd",
  "strategie.onepager.vast.themas.label":        "Strategische thema's",
  "strategie.onepager.vast.themas.sub_suffix":   "thema's",
  "strategie.onepager.group.analyse.label":      "Strategische analyse",
  "strategie.onepager.group.positionering.label":"Positionering",
  "strategie.onepager.group.doelen.label":       "Doelen & verschuiving",
  "strategie.model.swot":                        "SWOT-analyse",
  "strategie.model.swot.disabled_reason":        "Vul de SWOT-tabbladen in onder Strategie → Analyse.",
  "strategie.model.porter":                      "Porter 5 Forces",
  "strategie.model.porter.disabled_reason":      "Geen sector-analyse-velden in werkblad — komt in fase 2",
  "strategie.model.pestel":                      "PESTEL",
  "strategie.model.pestel.disabled_reason":      "Geen macro-analyse-velden in werkblad — komt in fase 2",
  "strategie.model.mckinsey7s":                  "McKinsey 7S",
  "strategie.model.mckinsey7s.disabled_reason":  "Geen interne-factoren-velden in werkblad — komt in fase 2",
  "strategie.model.ansoff":                      "Ansoff-matrix",
  "strategie.model.ansoff.disabled_reason":      "Geen groeirichting-velden in werkblad — komt in fase 2",
  "strategie.model.valuechain":                  "Value Chain",
  "strategie.model.valuechain.disabled_reason":  "Geen waardeketen-velden in werkblad — komt in fase 2",
  "strategie.model.vannaar":                     "Van → Naar tabel",
  "strategie.model.vannaar.disabled_reason":     "Geen verschuiving-velden in werkblad — komt in fase 2",
  "strategie.model.kernwaardenbord":             "Kernwaarden-bord",
  "strategie.model.kernwaardenbord.disabled_reason": "Voeg eerst minstens één kernwaarde toe onder Identiteit.",
  // 11.S Block 4 — StrategyOnePager v2 (brand-strip + titel + identiteits-band + KPI-fallbacks + themas + SWOT + AI + footer)
  "strategie.onepager.brand.fallback":              "Platform",
  "strategie.onepager.brand.kicker":                "Business Transformation Canvas",
  ...
  "strategie.onepager.identiteit.visie.label":      "VISIE",
  "strategie.onepager.identiteit.visie.fallback":   "Visie nog niet ingevuld",
  "strategie.onepager.identiteit.ambitie.label":    "AMBITIE",
  "strategie.onepager.identiteit.ambitie.fallback": "Ambitie nog niet ingevuld",
  "strategie.onepager.identiteit.ambitie.eyebrow":  "BHAG",
  "strategie.onepager.identiteit.kernwaarden.label":"KERNWAARDEN",
  "strategie.onepager.kpi.bhag_fallback.label":     "BHAG",
  "strategie.onepager.kpi.horizon_fallback.label":  "Horizon",
  "strategie.onepager.kpi.horizon_fallback.target": "5 jaar",
  "strategie.onepager.themas.titel":                "01 · STRATEGISCHE THEMA'S · KSF & KPI",
  "strategie.onepager.themas.fallback":             "Geen strategische thema's gedefinieerd — voeg eerst toe",
  "strategie.onepager.swot.titel":                  "SWOT-analyse — intern en extern",
  "strategie.onepager.swot.sterkten":               "Sterkten",
  "strategie.onepager.swot.zwakten":                "Zwakten",
  "strategie.onepager.swot.kansen":                 "Kansen",
  "strategie.onepager.swot.bedreigingen":           "Bedreigingen",
  "strategie.onepager.ai.titel":                    "AI · Aandachtspunten",
  ...
  "klanten.verbeteractie.error.sluit":               "Sluit",
  // 11.U Block 2b — Doorloop volledig (ChoiceCards + LensPicker + AiResultDraft + Focus + Eigen)
  "klanten.verbeteracties.choice.ai.titel":          "Genereer met AI",
  "klanten.verbeteracties.choice.ai.body":           "Laat AI een verbeteractie voorstellen op basis van een gekozen lens.",
  "klanten.verbeteracties.choice.eigen.titel":       "Schrijf eigen actie",
  "klanten.verbeteracties.choice.eigen.body":        "Formuleer zelf een verbeteractie voor dit pijnpunt.",
  "klanten.verbeteracties.choice.dismiss.titel":     "Niet adresseren",
  "klanten.verbeteracties.choice.dismiss.body":      "Markeer dit pijnpunt als bewust niet aangepakt — motivatie verplicht.",
  "klanten.verbeteracties.lens.cluster.titel":       "Cluster",
  "klanten.verbeteracties.lens.cluster.body":        "Combineer pijnpunten in samenhangend cluster-thema.",
  "klanten.verbeteracties.lens.paradox.titel":       "Paradox",
  "klanten.verbeteracties.lens.paradox.body":        "Identificeer onderliggende paradox of dilemma.",
  "klanten.verbeteracties.lens.positionering.titel": "Positionering",
  "klanten.verbeteracties.lens.positionering.body":  "Onderbouw vanuit strategische positionering.",
  "klanten.verbeteracties.lens.overstijgend.titel":  "Overstijgend",
  "klanten.verbeteracties.lens.overstijgend.body":   "Verbind aan hogere strategische lijn.",
  "klanten.verbeteracties.lens.algemeen.titel":      "Algemeen",
  "klanten.verbeteracties.lens.algemeen.body":       "Algemene verbeteringsaanbeveling.",
  "klanten.verbeteracties.lens.picker.titel":        "Kies een AI-lens",
  "klanten.verbeteracties.lens.picker.annuleer":     "Annuleren",
  "klanten.verbeteracties.ai_draft.titel":           "AI-suggestie ({lens})",
  "klanten.verbeteracties.ai_draft.titel_veld":      "Titel",
  "klanten.verbeteracties.ai_draft.intent_veld":     "Tekst",
  "klanten.verbeteracties.ai_draft.accepteer":       "Accepteer als concept",
  "klanten.verbeteracties.ai_draft.verfijn":         "Verfijn",
  "klanten.verbeteracties.ai_draft.wuif_weg":        "Wuif weg",
  "klanten.verbeteracties.ai_draft.error.no_result": "AI leverde geen suggestie",
  "klanten.verbeteracties.loading.collecting":       "Inputs verzamelen…",
  "klanten.verbeteracties.loading.ai_running":       "AI analyseert je pijnpunt… (dit duurt 20-40 seconden)",
  "klanten.verbeteracties.status.open":              "Open",
  "klanten.verbeteracties.status.addressed":         "Geadresseerd",
  "klanten.verbeteracties.status.dismissed":         "Genegeerd",
  "klanten.verbeteracties.actie.reopen":             "Maak opnieuw open",
  "klanten.verbeteracties.actie.vorige":             "Vorige",
  "klanten.verbeteracties.actie.volgende":           "Volgende",
  ...
  "klanten.verbeteracties.doorloop.counter":         "Pijnpunt",
  "klanten.verbeteracties.doorloop.empty.titel":     "Geen pijnpunten",
  "klanten.verbeteracties.doorloop.empty.body":      "Voeg eerst pijnpunten toe in fase 2 om de Doorloop te starten.",
  "klanten.verbeteracties.focus.pijnpunt_label":     "Pijnpunt",
  "klanten.verbeteracties.addressed.titel":          "Gekoppelde verbeteracties",
  "klanten.verbeteracties.addressed.leeg":           "(geen)",
  "klanten.verbeteracties.addressed.bewerk":         "Bewerk intent",
  "klanten.verbeteracties.dismissed.titel":          "Motivatie",
  "klanten.verbeteracties.dismissed.geen_motivatie": "(geen motivatie opgegeven)",
  "klanten.verbeteracties.eigen.titel":              "Eigen actie schrijven",
  "klanten.verbeteracties.eigen.titel_veld":         "Titel",
  "klanten.verbeteracties.eigen.intent_veld":        "Tekst",
  "klanten.verbeteracties.eigen.opslaan":            "Opslaan",
  "klanten.verbeteracties.eigen.annuleer":           "Annuleer",
