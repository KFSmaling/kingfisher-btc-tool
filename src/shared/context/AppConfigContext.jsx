...
const LABEL_FALLBACKS = {
  ...
  "klanten.analyse.actie.reject":                   "Wuif weg",
  "klanten.analyse.accept.tooltip.fase4":           "nog te promoten in fase 4 — komt later",
  ...
  "klanten.rapport.patronen.leeg":                  "Nog geen geaccepteerde patronen.",
};
